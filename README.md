...
Note: each time you commit to main, the CI script builds a new Docker image and pushes it to quay.io/librasteve/cragcli-info - you may wish to prune older versions from time to time.
